...
public partial class @XRIDefaultInputActions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""NonVRPlayer"",
            ""id"": ""7c47dfd7-245c-4bf7-abc1-db3824dfe7a1"",
            ""actions"": [
                {
                    ""name"": ""Camera"",
                    ""type"": ""Value"",
                    ""id"": ""f67e33bf-aea1-4b88-962d-8bc6270d8f3c"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
                },
                {
                    ""name"": ""Move"",
                    ""type"": ""Value"",
                    ""id"": ""e25102bd-8012-47dc-b6b9-b43458244d01"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
                },
                {
                    ""name"": ""Jump"",
                    ""type"": ""Button"",
                    ""id"": ""464615e8-78ab-4447-8c85-b5815dc2acf5"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""225208a0-1419-45e3-836d-58b602684625"",
                ...
                {
                    ""name"": ""WASD"",
                    ""id"": ""dc554837-035c-407c-b5c9-d482f8c2bc80"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""6cebf82b-4bfb-446e-9544-9f95d9fec24b"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""6e2ed85d-4647-41a8-ada6-dd5f26454378"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""600a19eb-8ca6-40b3-9fbc-2bba2acded4d"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""5739306b-99eb-4ea8-8e32-92a390aa294a"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
                ...
                {
                    ""name"": """",
                    ""id"": ""382b37ca-2e7f-4fe5-b5c5-546ba779ca0b"",
                ...
                {
                    ""name"": """",
                    ""id"": ""8aee2c89-65f4-401c-8dbe-07844a515e78"",
                    ""path"": ""<Mouse>/delta"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
                ...
                {
                    ""name"": """",
                    ""id"": ""39634604-92d0-48a9-85df-6003755e0283"",
                ...
                {
                    ""name"": """",
                    ""id"": ""d68fa001-0351-4fd9-a1ad-1a5815a26a46"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
    ...
    ""controlSchemes"": [
        ...
        // NonVRPlayer
        m_NonVRPlayer = asset.FindActionMap("NonVRPlayer", throwIfNotFound: true);
        m_NonVRPlayer_Camera = m_NonVRPlayer.FindAction("Camera", throwIfNotFound: true);
        m_NonVRPlayer_Move = m_NonVRPlayer.FindAction("Move", throwIfNotFound: true);
        m_NonVRPlayer_Jump = m_NonVRPlayer.FindAction("Jump", throwIfNotFound: true);
    }
    ...
    ~@XRIDefaultInputActions()
    {
        ...
        UnityEngine.Debug.Assert(!m_NonVRPlayer.enabled, "This will cause a leak and performance issues, XRIDefaultInputActions.NonVRPlayer.Disable() has not been called.");
    }
    ...
    // NonVRPlayer
    private readonly InputActionMap m_NonVRPlayer;
    private List<INonVRPlayerActions> m_NonVRPlayerActionsCallbackInterfaces = new List<INonVRPlayerActions>();
    private readonly InputAction m_NonVRPlayer_Camera;
    private readonly InputAction m_NonVRPlayer_Move;
    private readonly InputAction m_NonVRPlayer_Jump;
    /// <summary>
    /// Provides access to input actions defined in input action map "NonVRPlayer".
    /// </summary>
    public struct NonVRPlayerActions
    {
        private @XRIDefaultInputActions m_Wrapper;
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public NonVRPlayerActions(@XRIDefaultInputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "NonVRPlayer/Camera".
        /// </summary>
        public InputAction @Camera => m_Wrapper.m_NonVRPlayer_Camera;
        /// <summary>
        /// Provides access to the underlying input action "NonVRPlayer/Move".
        /// </summary>
        public InputAction @Move => m_Wrapper.m_NonVRPlayer_Move;
        /// <summary>
        /// Provides access to the underlying input action "NonVRPlayer/Jump".
        /// </summary>
        public InputAction @Jump => m_Wrapper.m_NonVRPlayer_Jump;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        public InputActionMap Get() { return m_Wrapper.m_NonVRPlayer; }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
        public void Enable() { Get().Enable(); }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
        public void Disable() { Get().Disable(); }
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="NonVRPlayerActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        public static implicit operator InputActionMap(NonVRPlayerActions set) { return set.Get(); }
        /// <summary>
        /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
        /// </summary>
        /// <param name="instance">Callback instance.</param>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="NonVRPlayerActions" />
        public void AddCallbacks(INonVRPlayerActions instance)
        {
            if (instance == null || m_Wrapper.m_NonVRPlayerActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_NonVRPlayerActionsCallbackInterfaces.Add(instance);
        ...
        /// </remarks>
        /// <seealso cref="NonVRPlayerActions" />
        private void UnregisterCallbacks(INonVRPlayerActions instance)
        {
            @Camera.started -= instance.OnCamera;
            @Camera.performed -= instance.OnCamera;
            @Camera.canceled -= instance.OnCamera;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="NonVRPlayerActions.UnregisterCallbacks(INonVRPlayerActions)" />.
        /// </summary>
        /// <seealso cref="NonVRPlayerActions.UnregisterCallbacks(INonVRPlayerActions)" />
        public void RemoveCallbacks(INonVRPlayerActions instance)
        {
            if (m_Wrapper.m_NonVRPlayerActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="NonVRPlayerActions.AddCallbacks(INonVRPlayerActions)" />
        /// <seealso cref="NonVRPlayerActions.RemoveCallbacks(INonVRPlayerActions)" />
        /// <seealso cref="NonVRPlayerActions.UnregisterCallbacks(INonVRPlayerActions)" />
        public void SetCallbacks(INonVRPlayerActions instance)
        {
            foreach (var item in m_Wrapper.m_NonVRPlayerActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_NonVRPlayerActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    /// Provides a new <see cref="NonVRPlayerActions" /> instance referencing this action map.
    /// </summary>
    public NonVRPlayerActions @NonVRPlayer => new NonVRPlayerActions(this);
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "NonVRPlayer" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="NonVRPlayerActions.AddCallbacks(INonVRPlayerActions)" />
    /// <seealso cref="NonVRPlayerActions.RemoveCallbacks(INonVRPlayerActions)" />
    public interface INonVRPlayerActions
    {
        /// <summary>
